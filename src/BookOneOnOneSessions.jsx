...
const BookOneOnOneSession = () => {
  ...
  // Using the same Calendly link as requested.
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-8 md:py-12">
        ...
        <div className="text-center mb-16 space-y-4">
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight">
            Book Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">First Session</span>
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-5">
                ...
                <div className="space-y-1.5">
                  <label className={`text-sm font-medium ml-1 ${styles.label}`}>
                    What would you like to work on? <span className={`text-xs ${styles.subtext}`}>(Optional)</span>
                  </label>
                  <textarea 
                    name="goals"
            ...
            {/* UPDATED FEE CARD (2000 INR) */}
            <div className={`rounded-2xl p-6 border flex items-center gap-4 transition-all duration-300 ${styles.feeCard}`}>
               {/* Just styling the price big and bold */}
              <div className="text-center w-full">
                <h3 className="text-3xl font-bold mb-1">₹2,000 <span className="text-sm font-normal text-gray-500">/ Session</span></h3>
          ...
          <div className="space-y-6">
            ...
            <div className={`backdrop-blur-xl border rounded-2xl p-1 transition-all duration-300 overflow-hidden relative min-h-[400px] flex flex-col ${styles.card}`}>
              ...
              <div className="p-6 md:p-8 pb-0">
                ...
                {!showCalendar && (
                  <p className={`text-sm ${styles.subtext}`}>Select a slot that works for you.</p>
                )}
              </div>
...
export default BookOneOnOneSession;